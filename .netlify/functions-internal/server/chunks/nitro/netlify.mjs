...
import { withoutBase, parseURL, withQuery, joinURL } from 'ufo';
...
const _lazy_RINKIz = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_RINKIz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_RINKIz, lazy: true, middleware: false, method: undefined }
];
